...
instances of string "webpa" to your new module name (eg "widget").
   
Rename the file lang/en_utf8/webpa.php to widget.php or whatever your
module name is.
...
should find that this webpa has been added to the list of recognized
modules.  
